...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="data/task1_sample.json")
    parser.add_argument(
        "--no_evaluation", action="store_true", help="Disable evaluation"
    )
    args = parser.parse_args()

    logger.info("🚀 Starting Task 1 execution")
    ...
    try:
        ...
        logger.success("✅ Task 1 completed successfully!")
